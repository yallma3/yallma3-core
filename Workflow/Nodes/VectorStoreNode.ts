        ...
        i18n: {
          en: {
            "Collection URL": {
              Name: "Collection URL",
              Description:
                "Full Pinecone index URL (with namespace path if needed)",
            },
          },
          ar: {
            "Collection URL": {
              Name: "رابط المجموعة",
              Description:
                "رابط فهرس Pinecone الكامل (مع مسار المساحة إذا لزم الأمر)",
            },
          },
        },
      },
    ...
    return {
      ...
      process: async (context: NodeExecutionContext) => {
        ...
        try {
          ...
          const vectorId = CryptoJS.SHA256(vector.join(",")).toString(
            CryptoJS.enc.Hex
          );
